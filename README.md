...
## Objective
My professional journey reflects a dedication to service excellence, complemented by a strong academic foundation in cybersecurity. Proficient in tools such as ELK, Wireshark and CLI, as well as frameworks such as MITRE ATT&CK, and NIST, I aim to integrate my technical knowledge with my commitment to customer satisfaction. My goal is to contribute to innovative and people-focused solutions while aligning with my organization's mission to deliver exceptional service and value.

## Skills
<ul>
  <li>Cybersecurity Fundamentals <br>
  <li>Network Security & Monitoring <br>
  <li>Threat Analysis & Risk Assessment <br>
  <li>Log Analysis & SIEM Concepts <br>
  <li>Security Protocols & Access Control <br>
  <li>Vulnerability Identification <br>
  <li>Incident Response Fundamentals <br>
  <li>Linux & Windows Environments <br>
